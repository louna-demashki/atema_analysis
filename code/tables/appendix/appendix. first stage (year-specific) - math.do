...
cap log close
log using "$output\Logs\2.a. first stage (year-specific) math.txt", text replace
...
texdoc init "$output\tables\appendix\2. appendix. first stage (year-specific) math.tex", replace force 
