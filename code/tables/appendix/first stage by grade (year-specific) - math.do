...
cap log close
log using "$output\Logs\first stage by grade (year-specific)_ math.txt", text replace
...
texdoc init "$output\tables\appendix\first stage by grade (year-specific)_math.tex", replace force 
