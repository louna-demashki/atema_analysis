...
cap log close
log using "$output\Logs\tables\appendix\heterogeneity FS (pooled B).txt", text replace
...
texdoc init "$output\tables\appendix\heterogeneity FS (pooled B).tex", replace force 
