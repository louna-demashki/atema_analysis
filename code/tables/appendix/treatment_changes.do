...
cap log close 
log using "$output\Logs\treatment_changes.txt", replace text 

use "${input}\master_khan_student_combined", clear 


// proportion of students in the same school
gen same_sc = 0
	replace same_sc = 1 if school_21 == SCHOOL_CODE
	
local grade "5 6 7 8 9"
foreach i of local grade{
	display "Grade `i'"
	sum same_sc if grade_21 == `i' & ACADEMIC_YEAR_ID_FK == 2023
	}
...
gen c_22=1 if treat1==0 & treat2==0 & ACADEMIC_YEAR_ID_FK==2022
...
gen c_23=1 if treat1==0 & treat2==0 & ACADEMIC_YEAR_ID_FK==2023
...
gen drop_22 = 0 
	replace drop_22 = 1 if s_c_22==0 & s_ta1_22==0 & s_ta2_22==0 & s_ta3_22==0 & s_ta4_22==0
	
gen drop_23 = 0 
	replace drop_23 = 1 if s_c_23==0 & s_ta1_23==0 & s_ta2_23==0 & s_ta3_23==0 & s_ta4_23==0
		
save "$input\interim\transfers", replace
...
gen t_drop_22 = 0 
	replace t_drop_22 = 1 if t_c_22==0 & t_ta1_22==0 & t_ta2_22==0 & t_ta3_22==0 & t_ta4_22==0
	
gen t_drop_23 = 0 
	replace t_drop_23 = 1 if t_c_23==0 & t_ta1_23==0 & t_ta2_23==0 & t_ta3_23==0 & t_ta4_23==0
...
// treatment in 2022 
use "$input\interim\transfers", clear 

drop if ACADEMIC_YEAR_ID_FK == 2023

local s_treat "s_ta1_22 s_ta2_22 s_ta3_22 s_ta4_22 s_c_22 drop_22" 
...
local t_treat "t_ta1_22 t_ta2_22 t_ta3_22 t_ta4_22 t_c_22 t_drop_22"
...
texdoc init "$output\tables\appendix\treatment_changes_22.tex", replace force 
	...
	tex \hline\hline
	tex &\multicolumn{6}{c}{Treatment Status in May 2022} &\multicolumn{1}{c}{} \\
	tex &\multicolumn{1}{c}{TA 1} &\multicolumn{1}{c}{TA 2} &\multicolumn{1}{c}{TA 3} &\multicolumn{1}{c}{TA 4} &\multicolumn{1}{c}{Control} &\multicolumn{1}{c}{Attrition} &\multicolumn{1}{c}{N} \\
	...
	tex &\multicolumn{7}{l}{textbf{Treatment status in September 2021}} \\
	tex [1ex]
	
	tex &\multicolumn{7}{l}{textit{Panel A: Student transfers}} \\
	tex [1ex]
	
	tex TA 1 & `s_ta1_22_b1' & `s_ta2_22_b1' & `s_ta3_22_b1' & `s_ta4_22_b1' & `s_c_22_b1' & `drop_22_b1' \\
	tex & `s_ta1_22_se1' & `s_ta2_22_se1' & `s_ta3_22_se1' & `s_ta4_22_se1' & `s_c_22_se1' & `drop_22_se1' \\
	tex [1ex]
	
	tex TA 2 & `s_ta1_22_b2' & `s_ta2_22_b2' & `s_ta3_22_b2' & `s_ta4_22_b2' & `s_c_22_b2' & `drop_22_b2' \\
	tex & `s_ta1_22_se2' & `s_ta2_22_se2' & `s_ta3_22_se2' & `s_ta4_22_se2' & `s_c_22_se2' & `drop_22_se2' \\
	tex [1ex]
	
	tex TA 3 & `s_ta1_22_b3' & `s_ta2_22_b3' & `s_ta3_22_b3' & `s_ta4_22_b3' & `s_c_22_b3' & `drop_22_b3' \\
	tex & `s_ta1_22_se3' & `s_ta2_22_se3' & `s_ta3_22_se3' & `s_ta4_22_se3' & `s_c_22_se3' & `drop_22_se3' \\
	tex [1ex]
	
	tex TA 4 & `s_ta1_22_b4' & `s_ta2_22_b4' & `s_ta3_22_b4' & `s_ta4_22_b4' & `s_c_22_b4' & `drop_22_b4' \\
	tex & `s_ta1_22_se4' & `s_ta2_22_se4' & `s_ta3_22_se4' & `s_ta4_22_se4' & `s_c_22_se4' & `drop_22_se4' \\
	tex [1ex]
	...
	tex &\multicolumn{7}{l}{textit{Panel B: Teacher transfers}} \\
	tex [1ex]
	
	tex TA 1 & `t_ta1_22_b1t' & `t_ta2_22_b1t' & `t_ta3_22_b1t' & `t_ta4_22_b1t' & `t_c_22_b1t' & `t_drop_22_b1t' & \\
	tex & `t_ta1_22_se1t' & `t_ta2_22_se1t' & `t_ta3_22_se1t' & `t_ta4_22_se1t' & `t_c_22_se1t' & `t_drop_22_se1t' & \\
	tex [1ex]
	
	tex TA 2 & `t_ta1_22_b2t' & `t_ta2_22_b2t' & `t_ta3_22_b2t' & `t_ta4_22_b2t' & `t_c_22_b2t' & `t_drop_22_b2t' & \\
	tex & `t_ta1_22_se2t' & `t_ta2_22_se2t' & `t_ta3_22_se2t' & `t_ta4_22_se2t' & `t_c_22_se2t' & `t_drop_22_se2t' & \\
	tex [1ex]
	
	tex TA 3 & `t_ta1_22_b3t' & `t_ta2_22_b3t' & `t_ta3_22_b3t' & `t_ta4_22_b3t' & `t_c_22_b3t' & `t_drop_22_b3t' & \\
	tex & `t_ta1_22_se3t' & `t_ta2_22_se3t' & `t_ta3_22_se3t' & `t_ta4_22_se3t' & `t_c_22_se3t' & `t_drop_22_se3t' & \\
	tex [1ex]
	
	tex TA 4 & `t_ta1_22_b4t' & `t_ta2_22_b4t' & `t_ta3_22_b4t' & `t_ta4_22_b4t' & `t_c_22_b4t' & `t_drop_22_b4t' & \\
	tex & `t_ta1_22_se4t' & `t_ta2_22_se4t' & `t_ta3_22_se4t' & `t_ta4_22_se4t' & `t_c_22_se4t' & `t_drop_22_se4t' & \\
	tex [1ex]
...
local s_treat "s_ta1_23 s_ta2_23 s_ta3_23 s_ta4_23 s_c_23 drop_23"
...
local t_treat "t_ta1_23 t_ta2_23 t_ta3_23 t_ta4_23 t_c_23 t_drop_23" 
...
texdoc init "$output\tables\appendix\treatment_changes_23.tex", replace force 
	...
	tex \begin{tabular}{l*{7}c}
	tex \hline\hline
	tex &\multicolumn{6}{c}{Treatment Status in May 2023} &\multicolumn{1}{c}{} \\
	tex &\multicolumn{1}{c}{TA 1} &\multicolumn{1}{c}{TA 2} &\multicolumn{1}{c}{TA 3} &\multicolumn{1}{c}{TA 4} &\multicolumn{1}{c}{Control} &\multicolumn{1}{c}{Attrition} &\multicolumn{1}{c}{N} \\
	tex &\multicolumn{1}{c}{(1)} &\multicolumn{1}{c}{(2)} &\multicolumn{1}{c}{(3)} &\multicolumn{1}{c}{(4)} &\multicolumn{1}{c}{(5)} &\multicolumn{1}{c}{(6)} &\multicolumn{1}{c}{(7)} \\
	tex \hline \\
	tex [1ex] 
	...
	tex TA 1 & `s_ta1_23_b1' & `s_ta2_23_b1' & `s_ta3_23_b1' & `s_ta4_23_b1' & `s_c_23_b1' & `drop_23_b1' & \\
	tex & `s_ta1_23_se1' & `s_ta2_23_se1' & `s_ta3_23_se1' & `s_ta4_23_se1' & `s_c_23_se1' & `drop_23_se1' & \\
	tex [1ex]
	
	tex TA 2 & `s_ta1_23_b2' & `s_ta2_23_b2' & `s_ta3_23_b2' & `s_ta4_23_b2' & `s_c_23_b2' & `drop_23_b2' & \\
	tex & `s_ta1_23_se2' & `s_ta2_23_se2' & `s_ta3_23_se2' & `s_ta4_23_se2' & `s_c_23_se2' & `drop_23_se2' & \\
	tex [1ex]
	
	tex TA 3 & `s_ta1_23_b3' & `s_ta2_23_b3' & `s_ta3_23_b3' & `s_ta4_23_b3' & `s_c_23_b3' & `drop_23_b3' & \\
	tex & `s_ta1_23_se3' & `s_ta2_23_se3' & `s_ta3_23_se3' & `s_ta4_23_se3' & `s_c_23_se3' & `drop_23_se3' & \\
	tex [1ex]
	
	tex TA 4 & `s_ta1_23_b4' & `s_ta2_23_b4' & `s_ta3_23_b4' & `s_ta4_23_b4' & `s_c_23_b4' & `drop_23_b4' & \\
	tex & `s_ta1_23_se4' & `s_ta2_23_se4' & `s_ta3_23_se4' & `s_ta4_23_se4' & `s_c_23_se4' & `drop_23_se4' & \\
	tex [1ex]
	...
	tex TA 1 & `t_ta1_23_b1t' & `t_ta2_23_b1t' & `t_ta3_23_b1t' & `t_ta4_23_b1t' & `t_c_23_b1t' & `t_drop_23_bt1' & \\
	tex & `t_ta1_23_se1t' & `t_ta2_23_se1t' & `t_ta3_23_se1t' & `t_ta4_23_se1t' & `t_c_23_se1t' & `t_drop_23_se1t' & \\
	tex [1ex]
	
	tex TA 2 & `t_ta1_23_b2t' & `t_ta2_23_b2t' & `t_ta3_23_b2t' & `t_ta4_23_b2t' & `t_c_23_b2t' & `t_drop_23_b2t' & \\
	tex & `t_ta1_23_se2t' & `t_ta2_23_se2t' & `t_ta3_23_se2t' & `t_ta4_23_se2t' & `t_c_23_se2t' & `t_drop_23_se2t' & \\
	tex [1ex]
	
	tex TA 3 & `t_ta1_23_b3t' & `t_ta2_23_b3t' & `t_ta3_23_b3t' & `t_ta4_23_b3t' & `t_c_23_b3t' & `t_drop_23_b3t' & \\
	tex & `t_ta1_23_se3t' & `t_ta2_23_se3t' & `t_ta3_23_se3t' & `t_ta4_23_se3t' & `t_c_23_se3t' & `t_drop_23_se3t' & \\
	tex [1ex]
	
	tex TA 4 & `t_ta1_23_b4t' & `t_ta2_23_b4t' & `t_ta3_23_b4t' & `t_ta4_23_b4t' & `t_c_23_b4t' & `t_drop_23_b4t' & \\
	tex & `t_ta1_23_se4t' & `t_ta2_23_se4t' & `t_ta3_23_se4t' & `t_ta4_23_se4t' & `t_c_23_se4t' & `t_drop_23_se4t' & \\	
	tex [1ex]
...
texdoc init "$output\tables\appendix\treatment_changes_23_by_grade.tex", replace force 
	...
	tex &\multicolumn{7}{l}{textit{Panel A: Grade 3}} \\
	tex [1ex]
	
	tex TA 1 & `s_ta1_23_b1_3' & `s_ta2_23_b1_3' & `s_ta3_23_b1_3' & `s_ta4_23_b1_3' & `s_c_23_b1_3' & `drop_23_b1_3' & \\
	tex & `s_ta1_23_se1_3' & `s_ta2_23_se1_3' & `s_ta3_23_se1_3' & `s_ta4_23_se1_3' & `s_c_23_se1_3' & `drop_23_se1_3' & \\
	tex [1ex]
	
	tex TA 2 & `s_ta1_23_b2_3' & `s_ta2_23_b2_3' & `s_ta3_23_b2_3' & `s_ta4_23_b2_3' & `s_c_23_b2_3' & `drop_23_b2_3' & \\
	tex & `s_ta1_23_se2_3' & `s_ta2_23_se2_3' & `s_ta3_23_se2_3' & `s_ta4_23_se2_3' & `s_c_23_se2_3' & `drop_23_se2_3' & \\
	tex [1ex]
	
	tex TA 3 & `s_ta1_23_b3_3' & `s_ta2_23_b3_3' & `s_ta3_23_b3_3' & `s_ta4_23_b3_3' & `s_c_23_b3_3' & `drop_23_b3_3' & \\
	tex & `s_ta1_23_se3_3' & `s_ta2_23_se3_3' & `s_ta3_23_se3_3' & `s_ta4_23_se3_3' & `s_c_23_se3_3' & `drop_23_se3_3' & \\
	tex [1ex]
	
	tex TA 4 & `s_ta1_23_b4_3' & `s_ta2_23_b4_3' & `s_ta3_23_b4_3' & `s_ta4_23_b4_3' & `s_c_23_b4_3' & `drop_23_b4_3' & \\
	tex & `s_ta1_23_se4_3' & `s_ta2_23_se4_3' & `s_ta3_23_se4_3' & `s_ta4_23_se4_3' & `s_c_23_se4_3' & `drop_23_se4_3' & \\
	tex [1ex]
	...
	tex &\multicolumn{7}{l}{textit{Panel B: Grade 4}} \\
	tex [1ex]
	
	tex TA 1 & `s_ta1_23_b1_4' & `s_ta2_23_b1_4' & `s_ta3_23_b1_4' & `s_ta4_23_b1_4' & `s_c_23_b1_4' & `drop_23_b1_4' & \\
	tex & `s_ta1_23_se1_4' & `s_ta2_23_se1_4' & `s_ta3_23_se1_4' & `s_ta4_23_se1_4' & `s_c_23_se1_4' & `drop_23_se1_4' & \\
	tex [1ex]
	
	tex TA 2 & `s_ta1_23_b2_4' & `s_ta2_23_b2_4' & `s_ta3_23_b2_4' & `s_ta4_23_b2_4' & `s_c_23_b2_4' & `drop_23_b2_4' & \\
	tex & `s_ta1_23_se2_4' & `s_ta2_23_se2_4' & `s_ta3_23_se2_4' & `s_ta4_23_se2_4' & `s_c_23_se2_4' & `drop_23_se2_4' & \\
	tex [1ex]
	
	tex TA 3 & `s_ta1_23_b3_4' & `s_ta2_23_b3_4' & `s_ta3_23_b3_4' & `s_ta4_23_b3_4' & `s_c_23_b3_4' & `drop_23_b3_4' & \\
	tex & `s_ta1_23_se3_4' & `s_ta2_23_se3_4' & `s_ta3_23_se3_4' & `s_ta4_23_se3_4' & `s_c_23_se3_4' & `drop_23_se3_4' & \\
	tex [1ex]
	
	tex TA 4 & `s_ta1_23_b4_4' & `s_ta2_23_b4_4' & `s_ta3_23_b4_4' & `s_ta4_23_b4_4' & `s_c_23_b4_4' & `drop_23_b4_4' & \\
	tex & `s_ta1_23_se4_4' & `s_ta2_23_se4_4' & `s_ta3_23_se4_4' & `s_ta4_23_se4_4' & `s_c_23_se4_4' & `drop_23_se4_4' & \\
	tex [1ex]
	...
	tex &\multicolumn{7}{l}{textit{Panel C: Grade 5}} \\
	tex [1ex]
	
	tex TA 1 & `s_ta1_23_b1_5' & `s_ta2_23_b1_5' & `s_ta3_23_b1_5' & `s_ta4_23_b1_5' & `s_c_23_b1_5' & `drop_23_b1_5' & \\
	tex & `s_ta1_23_se1_5' & `s_ta2_23_se1_5' & `s_ta3_23_se1_5' & `s_ta4_23_se1_5' & `s_c_23_se1_5' & `drop_23_se1_5' & \\
	tex [1ex]
	
	tex TA 2 & `s_ta1_23_b2_5' & `s_ta2_23_b2_5' & `s_ta3_23_b2_5' & `s_ta4_23_b2_5' & `s_c_23_b2_5' & `drop_23_b2_5' & \\
	tex & `s_ta1_23_se2_5' & `s_ta2_23_se2_5' & `s_ta3_23_se2_5' & `s_ta4_23_se2_5' & `s_c_23_se2_5' & `drop_23_se2_5' & \\
	tex [1ex]
	
	tex TA 3 & `s_ta1_23_b3_5' & `s_ta2_23_b3_5' & `s_ta3_23_b3_5' & `s_ta4_23_b3_5' & `s_c_23_b3_5' & `drop_23_b3_5' & \\
	tex & `s_ta1_23_se3_5' & `s_ta2_23_se3_5' & `s_ta3_23_se3_5' & `s_ta4_23_se3_5' & `s_c_23_se3_5' & `drop_23_se3_5' & \\
	tex [1ex]
	
	tex TA 4 & `s_ta1_23_b4_5' & `s_ta2_23_b4_5' & `s_ta3_23_b4_5' & `s_ta4_23_b4_5' & `s_c_23_b4_5' & `drop_23_b4_5' & \\
	tex & `s_ta1_23_se4_5' & `s_ta2_23_se4_5' & `s_ta3_23_se4_5' & `s_ta4_23_se4_5' & `s_c_23_se4_5' & `drop_23_se4_5' & \\
	tex [1ex]
	
	tex N & & & & & & &`s_ta1_23_obs_5' \\
	tex [1ex]
	
	tex &\multicolumn{7}{l}{textit{Panel D: Grade 6}} \\
	tex [1ex]
	
	tex TA 1 & `s_ta1_23_b1_6' & `s_ta2_23_b1_6' & `s_ta3_23_b1_6' & `s_ta4_23_b1_6' & `s_c_23_b1_6' & `drop_23_b1_6' & \\
	tex & `s_ta1_23_se1_6' & `s_ta2_23_se1_6' & `s_ta3_23_se1_6' & `s_ta4_23_se1_6' & `s_c_23_se1_6' & `drop_23_se1_6' & \\
	tex [1ex]
	
	tex TA 2 & `s_ta1_23_b2_6' & `s_ta2_23_b2_6' & `s_ta3_23_b2_6' & `s_ta4_23_b2_6' & `s_c_23_b2_6' & `drop_23_b2_6' & \\
	tex & `s_ta1_23_se2_6' & `s_ta2_23_se2_6' & `s_ta3_23_se2_6' & `s_ta4_23_se2_6' & `s_c_23_se2_6' & `drop_23_se2_6' & \\
	tex [1ex]
	
	tex TA 3 & `s_ta1_23_b3_6' & `s_ta2_23_b3_6' & `s_ta3_23_b3_6' & `s_ta4_23_b3_6' & `s_c_23_b3_6' & `drop_23_b3_6' & \\
	tex & `s_ta1_23_se3_6' & `s_ta2_23_se3_6' & `s_ta3_23_se3_6' & `s_ta4_23_se3_6' & `s_c_23_se3_6' & `drop_23_se3_6' & \\
	tex [1ex]
	
	tex TA 4 & `s_ta1_23_b4_6' & `s_ta2_23_b4_6' & `s_ta3_23_b4_6' & `s_ta4_23_b4_6' & `s_c_23_b4_6' & `drop_23_b4_6' & \\
	tex & `s_ta1_23_se4_6' & `s_ta2_23_se4_6' & `s_ta3_23_se4_6' & `s_ta4_23_se4_6' & `s_c_23_se4_6' & `drop_23_se4_6' & \\
	tex [1ex]
	
	tex N & & & & & & & `s_ta1_23_obs_6' \\
	tex [1ex]
	
	tex &\multicolumn{7}{l}{textit{Panel E: Grade 7}} \\
	tex [1ex]
	
	tex TA 1 & `s_ta1_23_b1_7' & `s_ta2_23_b1_7' & `s_ta3_23_b1_7' & `s_ta4_23_b1_7' & `s_c_23_b1_7' & `drop_23_b1_7' & \\
	tex & `s_ta1_23_se1_7' & `s_ta2_23_se1_7' & `s_ta3_23_se1_7' & `s_ta4_23_se1_7' & `s_c_23_se1_7' & `drop_23_se1_7' & \\
	tex [1ex]
	
	tex TA 2 & `s_ta1_23_b2_7' & `s_ta2_23_b2_7' & `s_ta3_23_b2_7' & `s_ta4_23_b2_7' & `s_c_23_b2_7' & `drop_23_b2_7' & \\
	tex & `s_ta1_23_se2_7' & `s_ta2_23_se2_7' & `s_ta3_23_se2_7' & `s_ta4_23_se2_7' & `s_c_23_se2_7' & `drop_23_se2_7' & \\
	tex [1ex]
	
	tex TA 3 & `s_ta1_23_b3_7' & `s_ta2_23_b3_7' & `s_ta3_23_b3_7' & `s_ta4_23_b3_7' & `s_c_23_b3_7' & `drop_23_b3_7' & \\
	tex & `s_ta1_23_se3_7' & `s_ta2_23_se3_7' & `s_ta3_23_se3_7' & `s_ta4_23_se3_7' & `s_c_23_se3_7' & `drop_23_se3_7' & \\
	tex [1ex]
	
	tex TA 4 & `s_ta1_23_b4_7' & `s_ta2_23_b4_7' & `s_ta3_23_b4_7' & `s_ta4_23_b4_7' & `s_c_23_b4_7' & `drop_23_b4_7' & \\
	tex & `s_ta1_23_se4_7' & `s_ta2_23_se4_7' & `s_ta3_23_se4_7' & `s_ta4_23_se4_7' & `s_c_23_se4_7' & `drop_23_se4_7' & \\
	tex [1ex]
...
texdoc init "$output\tables\appendix\treatment_changes_22_by_grade.tex", replace force 
	...
	tex &\multicolumn{7}{l}{textit{Panel A: Grade 4}} \\
	tex [1ex]
	
	tex TA 1 & `s_ta1_22_b1_41' & `s_ta2_22_b1_41' & `s_ta3_22_b1_41' & `s_ta4_22_b1_41' & `s_c_22_b1_41' & `drop_22_b1_41' & \\
	tex & `s_ta1_22_se1_41' & `s_ta2_22_se1_41' & `s_ta3_22_se1_41' & `s_ta4_22_se1_41' & `s_c_22_se1_41' & `drop_22_se1_41' & \\
	tex [1ex]
	
	tex TA 2 & `s_ta1_22_b2_41' & `s_ta2_22_b2_41' & `s_ta3_22_b2_41' & `s_ta4_22_b2_41' & `s_c_22_b2_41' & `drop_22_b2_41' & \\
	tex & `s_ta1_22_se2_41' & `s_ta2_22_se2_41' & `s_ta3_22_se2_41' & `s_ta4_22_se2_41' & `s_c_22_se2_41' & `drop_22_se2_41' & \\
	tex [1ex]
	
	tex TA 3 & `s_ta1_22_b3_41' & `s_ta2_22_b3_41' & `s_ta3_22_b3_41' & `s_ta4_22_b3_41' & `s_c_22_b3_41' & `drop_22_b3_41' & \\
	tex & `s_ta1_22_se3_41' & `s_ta2_22_se3_41' & `s_ta3_22_se3_41' & `s_ta4_22_se3_41' & `s_c_22_se3_41' & `drop_22_se3_41' & \\
	tex [1ex]
	
	tex TA 4 & `s_ta1_22_b4_41' & `s_ta2_22_b4_41' & `s_ta3_22_b4_41' & `s_ta4_22_b4_41' & `s_c_22_b4_41' & `drop_22_b4_41' & \\
	tex & `s_ta1_22_se4_41' & `s_ta2_22_se4_41' & `s_ta3_22_se4_41' & `s_ta4_22_se4_41' & `s_c_22_se4_41' & `drop_22_se4_41' & \\
	tex [1ex]
		
	tex N & & & & & & & `s_ta1_22_obs_41' \\
	tex [1ex]
	
	tex &\multicolumn{7}{l}{textit{Panel B: Grade 5}} \\
	tex [1ex]
	
	tex TA 1 & `s_ta1_22_b1_51' & `s_ta2_22_b1_51' & `s_ta3_22_b1_51' & `s_ta4_22_b1_51' & `s_c_22_b1_51' & `drop_22_b1_51' & \\
	tex & `s_ta1_22_se1_51' & `s_ta2_22_se1_51' & `s_ta3_22_se1_51' & `s_ta4_22_se1_51' & `s_c_22_se1_51' & `drop_22_se1_51' & \\
	tex [1ex]
	
	tex TA 2 & `s_ta1_22_b2_51' & `s_ta2_22_b2_51' & `s_ta3_22_b2_51' & `s_ta4_22_b2_51' & `s_c_22_b2_51' & `drop_22_b2_51' & \\
	tex & `s_ta1_22_se2_51' & `s_ta2_22_se2_51' & `s_ta3_22_se2_51' & `s_ta4_22_se2_51' & `s_c_22_se2_51' & `drop_22_se2_51' & \\
	tex [1ex]
	
	tex TA 3 & `s_ta1_22_b3_51' & `s_ta2_22_b3_51' & `s_ta3_22_b3_51' & `s_ta4_22_b3_51' & `s_c_22_b3_51' & `drop_22_b3_51' & \\
	tex & `s_ta1_22_se3_51' & `s_ta2_22_se3_51' & `s_ta3_22_se3_51' & `s_ta4_22_se3_51' & `s_c_22_se3_51' & `drop_22_se3_51' & \\
	tex [1ex]
	
	tex TA 4 & `s_ta1_22_b4_51' & `s_ta2_22_b4_51' & `s_ta3_22_b4_51' & `s_ta4_22_b4_51' & `s_c_22_b4_51' & `drop_22_b4_51' & \\
	tex & `s_ta1_22_se4_51' & `s_ta2_22_se4_51' & `s_ta3_22_se4_51' & `s_ta4_22_se4_51' & `s_c_22_se4_51' & `drop_22_se4_51' & \\
	tex [1ex]
	...
	tex &\multicolumn{7}{l}{textit{Panel C: Grade 6}} \\
	tex [1ex]
	
	tex TA 1 & `s_ta1_22_b1_61' & `s_ta2_22_b1_61' & `s_ta3_22_b1_61' & `s_ta4_22_b1_61' & `s_c_22_b1_61' & `drop_22_b1_61' & \\
	tex & `s_ta1_22_se1_61' & `s_ta2_22_se1_61' & `s_ta3_22_se1_61' & `s_ta4_22_se1_61' & `s_c_22_se1_61' & `drop_22_se1_61' & \\
	tex [1ex]
	
	tex TA 2 & `s_ta1_22_b2_61' & `s_ta2_22_b2_61' & `s_ta3_22_b2_61' & `s_ta4_22_b2_61' & `s_c_22_b2_61' & `drop_22_b2_61' & \\
	tex & `s_ta1_22_se2_61' & `s_ta2_22_se2_61' & `s_ta3_22_se2_61' & `s_ta4_22_se2_61' & `s_c_22_se2_61' & `drop_22_se2_61' & \\
	tex [1ex]
	
	tex TA 3 & `s_ta1_22_b3_61' & `s_ta2_22_b3_61' & `s_ta3_22_b3_61' & `s_ta4_22_b3_61' & `s_c_22_b3_61' & `drop_22_b3_61' & \\
	tex & `s_ta1_22_se3_61' & `s_ta2_22_se3_61' & `s_ta3_22_se3_61' & `s_ta4_22_se3_61' & `s_c_22_se3_61' & `drop_22_se3_61' & \\
	tex [1ex]
	
	tex TA 4 & `s_ta1_22_b4_61' & `s_ta2_22_b4_61' & `s_ta3_22_b4_61' & `s_ta4_22_b4_61' & `s_c_22_b4_61' & `drop_22_b4_61' & \\
	tex & `s_ta1_22_se4_61' & `s_ta2_22_se4_61' & `s_ta3_22_se4_61' & `s_ta4_22_se4_61' & `s_c_22_se4_61' & `drop_22_se4_61' & \\
	tex [1ex]
	...
	tex &\multicolumn{7}{l}{textit{Panel D: Grade 7}} \\
	tex [1ex]
	
	tex TA 1 & `s_ta1_22_b1_71' & `s_ta2_22_b1_71' & `s_ta3_22_b1_71' & `s_ta4_22_b1_71' & `s_c_22_b1_71' & `drop_22_b1_71' & \\
	tex & `s_ta1_22_se1_71' & `s_ta2_22_se1_71' & `s_ta3_22_se1_71' & `s_ta4_22_se1_71' & `s_c_22_se1_71' & `drop_22_se1_71' & \\
	tex [1ex]
	
	tex TA 2 & `s_ta1_22_b2_71' & `s_ta2_22_b2_71' & `s_ta3_22_b2_71' & `s_ta4_22_b2_71' & `s_c_22_b2_71' & `drop_22_b2_71' & \\
	tex & `s_ta1_22_se2_71' & `s_ta2_22_se2_71' & `s_ta3_22_se2_71' & `s_ta4_22_se2_71' & `s_c_22_se2_71' & `drop_22_se2_71' & \\
	tex [1ex]
	
	tex TA 3 & `s_ta1_22_b3_71' & `s_ta2_22_b3_71' & `s_ta3_22_b3_71' & `s_ta4_22_b3_71' & `s_c_22_b3_71' & `drop_22_b3_71' & \\
	tex & `s_ta1_22_se3_71' & `s_ta2_22_se3_71' & `s_ta3_22_se3_71' & `s_ta4_22_se3_71' & `s_c_22_se3_71' & `drop_22_se3_71' & \\
	tex [1ex]
	
	tex TA 4 & `s_ta1_22_b4_71' & `s_ta2_22_b4_71' & `s_ta3_22_b4_71' & `s_ta4_22_b4_71' & `s_c_22_b4_71' & `drop_22_b4_71' & \\
	tex & `s_ta1_22_se4_71' & `s_ta2_22_se4_71' & `s_ta3_22_se4_71' & `s_ta4_22_se4_71' & `s_c_22_se4_71' & `drop_22_se4_71' & \\
	tex [1ex]
	...
	tex &\multicolumn{7}{l}{textit{Panel E: Grade 8}} \\
	tex [1ex]
	
	tex TA 1 & `s_ta1_22_b1_81' & `s_ta2_22_b1_81' & `s_ta3_22_b1_81' & `s_ta4_22_b1_81' & `s_c_22_b1_81' & `drop_22_b1_81' & \\
	tex & `s_ta1_22_se1_81' & `s_ta2_22_se1_81' & `s_ta3_22_se1_81' & `s_ta4_22_se1_81' & `s_c_22_se1_81' & `drop_22_se1_81' & \\
	tex [1ex]
	
	tex TA 2 & `s_ta1_22_b2_81' & `s_ta2_22_b2_81' & `s_ta3_22_b2_81' & `s_ta4_22_b2_81' & `s_c_22_b2_81' & `drop_22_b2_81' & \\
	tex & `s_ta1_22_se2_81' & `s_ta2_22_se2_81' & `s_ta3_22_se2_81' & `s_ta4_22_se2_81' & `s_c_22_se2_81' & `drop_22_se2_81' & \\
	tex [1ex]
	
	tex TA 3 & `s_ta1_22_b3_81' & `s_ta2_22_b3_81' & `s_ta3_22_b3_81' & `s_ta4_22_b3_81' & `s_c_22_b3_81' & `drop_22_b3_81' & \\
	tex & `s_ta1_22_se3_81' & `s_ta2_22_se3_81' & `s_ta3_22_se3_81' & `s_ta4_22_se3_81' & `s_c_22_se3_81' & `drop_22_se3_81' & \\
	tex [1ex]
	
	tex TA 4 & `s_ta1_22_b4_81' & `s_ta2_22_b4_81' & `s_ta3_22_b4_81' & `s_ta4_22_b4_81' & `s_c_22_b4_81' & `drop_22_b4_81' & \\
	tex & `s_ta1_22_se4_81' & `s_ta2_22_se4_81' & `s_ta3_22_se4_81' & `s_ta4_22_se4_81' & `s_c_22_se4_81' & `drop_22_se4_81' & \\
	tex [1ex]
...
local ta_22 "s_ta1_22 s_ta2_22 s_ta3_22 s_ta4_22 s_c_22 drop_22"
foreach i of local ta_22{
	display "`i' and TA 1"
	count if ACADEMIC_YEAR_ID_FK==2022 & `i'==1 & treat_arm_1==1
	display "`i' and TA 2"
	count if ACADEMIC_YEAR_ID_FK==2022 & `i'==1 & treat_arm_2==1
	display "`i' and TA 3"
	count if ACADEMIC_YEAR_ID_FK==2022 & `i'==1 & treat_arm_3==1
	display "`i' and TA 4"
	count if ACADEMIC_YEAR_ID_FK==2022 & `i'==1 & treat_arm_4==1
	}

local ta_22 "s_ta1_22 s_ta2_22 s_ta3_22 s_ta4_22 s_c_22 drop_22"
foreach i of local ta_22{
	display "`i' and TA 1"
	count if ACADEMIC_YEAR_ID_FK==2022 & `i'==1 & treat_arm_1==1 & grade_21==6
	display "`i' and TA 2"
	count if ACADEMIC_YEAR_ID_FK==2022 & `i'==1 & treat_arm_2==1 & grade_21==6
	display "`i' and TA 3"
	count if ACADEMIC_YEAR_ID_FK==2022 & `i'==1 & treat_arm_3==1 & grade_21==6
	display "`i' and TA 4"
	count if ACADEMIC_YEAR_ID_FK==2022 & `i'==1 & treat_arm_4==1 & grade_21==6
	}

local ta_22 "s_ta1_22 s_ta2_22 s_ta3_22 s_ta4_22 s_c_22 drop_22"
foreach i of local ta_22{
	display "`i' and TA 1"
	count if ACADEMIC_YEAR_ID_FK==2022 & `i'==1 & treat_arm_1==1 & grade_21==7
	display "`i' and TA 2"
	count if ACADEMIC_YEAR_ID_FK==2022 & `i'==1 & treat_arm_2==1 & grade_21==7
	display "`i' and TA 3"
	count if ACADEMIC_YEAR_ID_FK==2022 & `i'==1 & treat_arm_3==1 & grade_21==7
	display "`i' and TA 4"
	count if ACADEMIC_YEAR_ID_FK==2022 & `i'==1 & treat_arm_4==1 & grade_21==7
	}

local ta_22 "s_ta1_22 s_ta2_22 s_ta3_22 s_ta4_22 s_c_22 drop_22"
foreach i of local ta_22{
	display "`i' and TA 1"
	count if ACADEMIC_YEAR_ID_FK==2022 & `i'==1 & treat_arm_1==1 & grade_21==8
	display "`i' and TA 2"
	count if ACADEMIC_YEAR_ID_FK==2022 & `i'==1 & treat_arm_2==1 & grade_21==8
	display "`i' and TA 3"
	count if ACADEMIC_YEAR_ID_FK==2022 & `i'==1 & treat_arm_3==1 & grade_21==8
	display "`i' and TA 4"
	count if ACADEMIC_YEAR_ID_FK==2022 & `i'==1 & treat_arm_4==1 & grade_21==8
	}
		
local ta_22 "s_ta1_22 s_ta2_22 s_ta3_22 s_ta4_22 s_c_22 drop_22"
foreach i of local ta_22{
	display "`i' and TA 1"
	count if ACADEMIC_YEAR_ID_FK==2022 & `i'==1 & treat_arm_1==1 & grade_21==9
	display "`i' and TA 2"
	count if ACADEMIC_YEAR_ID_FK==2022 & `i'==1 & treat_arm_2==1 & grade_21==9
	display "`i' and TA 3"
	count if ACADEMIC_YEAR_ID_FK==2022 & `i'==1 & treat_arm_3==1 & grade_21==9
	display "`i' and TA 4"
	count if ACADEMIC_YEAR_ID_FK==2022 & `i'==1 & treat_arm_4==1 & grade_21==9
	}
		
local ta_22 "s_ta1_22 s_ta2_22 s_ta3_22 s_ta4_22 s_c_22 drop_22"
foreach i of local ta_22{
	display "`i' and TA 1"
	count if ACADEMIC_YEAR_ID_FK==2022 & `i'==1 & treat_arm_1==1 & grade_21==10
	display "`i' and TA 2"
	count if ACADEMIC_YEAR_ID_FK==2022 & `i'==1 & treat_arm_2==1 & grade_21==10
	display "`i' and TA 3"
	count if ACADEMIC_YEAR_ID_FK==2022 & `i'==1 & treat_arm_3==1 & grade_21==10
	display "`i' and TA 4"
	count if ACADEMIC_YEAR_ID_FK==2022 & `i'==1 & treat_arm_4==1 & grade_21==10
	}
...
local ta_23 "s_ta1_23 s_ta2_23 s_ta3_23 s_ta4_23 s_c_23 drop_23"
foreach i of local ta_23{
	display "`i' and TA 1"
	count if ACADEMIC_YEAR_ID_FK==2023 & `i'==1 & treat_arm_1==1
	display "`i' and TA 2"
	count if ACADEMIC_YEAR_ID_FK==2023 & `i'==1 & treat_arm_2==1
	display "`i' and TA 3"
	count if ACADEMIC_YEAR_ID_FK==2023 & `i'==1 & treat_arm_3==1
	display "`i' and TA 4"
	count if ACADEMIC_YEAR_ID_FK==2023 & `i'==1 & treat_arm_4==1
	}

local ta_23 "s_ta1_23 s_ta2_23 s_ta3_23 s_ta4_23 s_c_23 drop_23"
foreach i of local ta_23{
	display "`i' and TA 1"
	count if ACADEMIC_YEAR_ID_FK==2023 & `i'==1 & treat_arm_1==1 & grade_21==5
	display "`i' and TA 2"
	count if ACADEMIC_YEAR_ID_FK==2023 & `i'==1 & treat_arm_2==1 & grade_21==5
	display "`i' and TA 3"
	count if ACADEMIC_YEAR_ID_FK==2023 & `i'==1 & treat_arm_3==1 & grade_21==5
	display "`i' and TA 4"
	count if ACADEMIC_YEAR_ID_FK==2023 & `i'==1 & treat_arm_4==1 & grade_21==5
	}

local ta_23 "s_ta1_23 s_ta2_23 s_ta3_23 s_ta4_23 s_c_23 drop_23"
foreach i of local ta_23{
	display "`i' and TA 1"
	count if ACADEMIC_YEAR_ID_FK==2023 & `i'==1 & treat_arm_1==1 & grade_21==6
	display "`i' and TA 2"
	count if ACADEMIC_YEAR_ID_FK==2023 & `i'==1 & treat_arm_2==1 & grade_21==6
	display "`i' and TA 3"
	count if ACADEMIC_YEAR_ID_FK==2023 & `i'==1 & treat_arm_3==1 & grade_21==6
	display "`i' and TA 4"
	count if ACADEMIC_YEAR_ID_FK==2023 & `i'==1 & treat_arm_4==1 & grade_21==6
	}

local ta_23 "s_ta1_23 s_ta2_23 s_ta3_23 s_ta4_23 s_c_23 drop_23"
foreach i of local ta_23{
	display "`i' and TA 1"
	count if ACADEMIC_YEAR_ID_FK==2023 & `i'==1 & treat_arm_1==1 & grade_21==7
	display "`i' and TA 2"
	count if ACADEMIC_YEAR_ID_FK==2023 & `i'==1 & treat_arm_2==1 & grade_21==7
	display "`i' and TA 3"
	count if ACADEMIC_YEAR_ID_FK==2023 & `i'==1 & treat_arm_3==1 & grade_21==7
	display "`i' and TA 4"
	count if ACADEMIC_YEAR_ID_FK==2023 & `i'==1 & treat_arm_4==1 & grade_21==7
	}
		
local ta_23 "s_ta1_23 s_ta2_23 s_ta3_23 s_ta4_23 s_c_23 drop_23"
foreach i of local ta_23{
	display "`i' and TA 1"
	count if ACADEMIC_YEAR_ID_FK==2023 & `i'==1 & treat_arm_1==1 & grade_21==8
	display "`i' and TA 2"
	count if ACADEMIC_YEAR_ID_FK==2023 & `i'==1 & treat_arm_2==1 & grade_21==8
	display "`i' and TA 3"
	count if ACADEMIC_YEAR_ID_FK==2023 & `i'==1 & treat_arm_3==1 & grade_21==8
	display "`i' and TA 4"
	count if ACADEMIC_YEAR_ID_FK==2023 & `i'==1 & treat_arm_4==1 & grade_21==8
	}
		
local ta_23 "s_ta1_23 s_ta2_23 s_ta3_23 s_ta4_23 s_c_23 drop_23"
foreach i of local ta_23{
	display "`i' and TA 1"
	count if ACADEMIC_YEAR_ID_FK==2023 & `i'==1 & treat_arm_1==1 & grade_21==9
	display "`i' and TA 2"
	count if ACADEMIC_YEAR_ID_FK==2023 & `i'==1 & treat_arm_2==1 & grade_21==9
	display "`i' and TA 3"
	count if ACADEMIC_YEAR_ID_FK==2023 & `i'==1 & treat_arm_3==1 & grade_21==9
	display "`i' and TA 4"
	count if ACADEMIC_YEAR_ID_FK==2023 & `i'==1 & treat_arm_4==1 & grade_21==9
	}


// CHECKING WHERE ATTRITION GOES
	// schools that were not in the randomization sample 
	gen flag_school=0
		replace flag_school=1 if SCHOOL_CODE==13474 | SCHOOL_CODE==14316 | SCHOOL_CODE==17343 | ///
		SCHOOL_CODE==23440 | SCHOOL_CODE==25155 | SCHOOL_CODE==26021 | SCHOOL_CODE==32300 | ///
		SCHOOL_CODE==35550 | SCHOOL_CODE==47589 | SCHOOL_CODE==48330 | SCHOOL_CODE==51334 | ///
		SCHOOL_CODE==52159 | SCHOOL_CODE==57638
