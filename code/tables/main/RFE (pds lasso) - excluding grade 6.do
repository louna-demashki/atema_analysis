//----------------------------------------------------------------------------//
// File name: RFE (pds lasso) - excluding grade 6
// Last updated: Dec. 2, 2024 by Sara Mostafa
//----------------------------------------------------------------------------//
...
cap log close
log using "$output\Logs\tables\appendix\RFE (pds lasso) - excluding grade 6.txt", text replace
...
// excluding grade 6 (in September 2021) test scores in 2023
replace math_score=. if grade_21==7 & ACADEMIC_YEAR_ID_FK==2023
...
texdoc init "$output\tables\appendix\RFE (excluding grade 6 in 2023).tex", replace force 
	tex \begin{table}[htbp]
	tex \centering
	tex \resizebox{\linewidth}{!}{%
	tex \begin{threeparttable}
	tex \caption{\textbf{Reduced Form Effects on Math Scores} (excluding grade 6 in 2023)}
