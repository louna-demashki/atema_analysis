...
cap log close
log using "$output\Logs\tables\main\av_table_FS.txt", text replace
...
global controls_7 "b_math_21 missing_b_math_21 gender b_special_ed b_math_19 missing_b_math_19 b_spa_19 missing_b_spa_19 missing_b_spa_21 b_eng_21 b_eng_21_sq missing_b_eng_21 missing_b_eng_19 b_GPA missing_b_GPA b_GPA_mate missing_b_GPA_mate b_GPA_espa missing_b_GPA_espa missing_b_GPA_ingl b_ABSENCE_COUNT_YEAR b_ABSENCE_COUNT_YEAR_sq b_ANNUAL_INCOME missing_b_ANNUAL_INCOME b_gr38_avg missing_b_gr38_avg x_math_19_gpa x_eng_21_gpa_m x_eng_21_eng_19 x_eng_21_gpa_e x_eng_21_gpa_s x_eng_21_sp_ed x_gpa_m_gpa_s x_gpa_m_gpa_e x_gpa_m_income x_gpa_s_sp_ed x_gpa_sp_ed"
	...
	// Model 1
	reghdfe takeup atema_st atema_pe_st atema_lt atema_pe_lt $controls_1, ///
	absorb(grade_21 strata) vce(clustervar school_21)
		...
		if pval3_1 < 0.01 local takeup_b3_1 = strtrim("`b3_1'") + "\sym{***}"
		else if pval3_1 < 0.05 local takeup_b3_1 = strtrim("`b3_1'") + "\sym{**}"
		else if pval3_1 < 0.1 local takeup_b3_1 = strtrim("`b3_1'") + "\sym{*}"
		else local takeup_b3_1 = strtrim("`b3_1'")
		local se3_1: display `format' _se[atema_lt]
		local takeup_se3_1 = "(" + strtrim("`se3_1'") + ")"
		...
		if pval4_1 < 0.01 local takeup_b4_1 = strtrim("`b4_1'") + "\sym{***}"
		else if pval4_1 < 0.05 local takeup_b4_1 = strtrim("`b4_1'") + "\sym{**}"
		else if pval4_1 < 0.1 local takeup_b4_1 = strtrim("`b4_1'") + "\sym{*}"
		else local takeup_b4_1 = strtrim("`b4_1'")
		local se4_1: display `format' _se[atema_pe_lt]
		local takeup_se4_1 = "(" + strtrim("`se4_1'") + ")"
		
		local takeup_obs_1: display %9.0fc e(N)
		
		test atema_st = atema_pe_st
		local takeup_pval1_1: display `format' r(p)
		
		test atema_st = atema_lt
		local takeup_pval2_1: display `format' r(p)
		
		test atema_pe_st = atema_pe_lt
		local takeup_pval3_1: display `format' r(p)
		
		
		
	// Model 2
	reghdfe takeup atema_st atema_pe_st atema_lt atema_pe_lt $controls_2, ///
	absorb(grade_21 strata) vce(clustervar school_21)
		...
		if pval3_2 < 0.01 local takeup_b3_2 = strtrim("`b3_2'") + "\sym{***}"
		else if pval3_2 < 0.05 local takeup_b3_2 = strtrim("`b3_2'") + "\sym{**}"
		else if pval3_2 < 0.1 local takeup_b3_2 = strtrim("`b3_2'") + "\sym{*}"
		else local takeup_b3_2 = strtrim("`b3_2'")
		local se3_2: display `format' _se[atema_lt]
		local takeup_se3_2 = "(" + strtrim("`se3_2'") + ")"
		...
		if pval4_2 < 0.01 local takeup_b4_2 = strtrim("`b4_2'") + "\sym{***}"
		else if pval4_2 < 0.05 local takeup_b4_2 = strtrim("`b4_2'") + "\sym{**}"
		else if pval4_2 < 0.1 local takeup_b4_2 = strtrim("`b4_2'") + "\sym{*}"
		else local takeup_b4_2 = strtrim("`b4_2'")
		local se4_2: display `format' _se[atema_pe_lt]
		local takeup_se4_2 = "(" + strtrim("`se4_2'") + ")"
		
		local takeup_obs_2: display %9.0fc e(N)
		
		test atema_st = atema_pe_st
		local takeup_pval1_2: display `format' r(p)
		
		test atema_st = atema_lt
		local takeup_pval2_2: display `format' r(p)
		
		test atema_pe_st = atema_pe_lt
		local takeup_pval3_2: display `format' r(p)
		
		
		
	// Model 3
	reghdfe takeup atema_st atema_pe_st atema_lt atema_pe_lt $controls_3, ///
	absorb(grade_21 strata) vce(clustervar school_21)
		...
		if pval3_3 < 0.01 local takeup_b3_3 = strtrim("`b3_3'") + "\sym{***}"
		else if pval3_3 < 0.05 local takeup_b3_3 = strtrim("`b3_3'") + "\sym{**}"
		else if pval3_3 < 0.1 local takeup_b3_3 = strtrim("`b3_3'") + "\sym{*}"
		else local takeup_b3_3 = strtrim("`b3_3'")
		local se3_3: display `format' _se[atema_lt]
		local takeup_se3_3 = "(" + strtrim("`se3_3'") + ")"
		...
		if pval4_3 < 0.01 local takeup_b4_3 = strtrim("`b4_3'") + "\sym{***}"
		else if pval4_3 < 0.05 local takeup_b4_3 = strtrim("`b4_3'") + "\sym{**}"
		else if pval4_3 < 0.1 local takeup_b4_3 = strtrim("`b4_3'") + "\sym{*}"
		else local takeup_b4_3 = strtrim("`b4_3'")
		local se4_3: display `format' _se[atema_pe_lt]
		local takeup_se4_3 = "(" + strtrim("`se4_3'") + ")"
		
		local takeup_obs_3: display %9.0fc e(N)
		
		test atema_st = atema_pe_st
		local takeup_pval1_3: display `format' r(p)
		
		test atema_st = atema_lt
		local takeup_pval2_3: display `format' r(p)
		
		test atema_pe_st = atema_pe_lt
		local takeup_pval3_3: display `format' r(p)
		
		
		
	// Model 4
	reghdfe takeup atema_st atema_pe_st atema_lt atema_pe_lt $controls_4, ///
	absorb(grade_21 strata) vce(clustervar school_21)
		...
		if pval3_4 < 0.01 local takeup_b3_4 = strtrim("`b3_4'") + "\sym{***}"
		else if pval3_4 < 0.05 local takeup_b3_4 = strtrim("`b3_4'") + "\sym{**}"
		else if pval3_4 < 0.1 local takeup_b3_4 = strtrim("`b3_4'") + "\sym{*}"
		else local takeup_b3_4 = strtrim("`b3_4'")
		local se3_4: display `format' _se[atema_lt]
		local takeup_se3_4 = "(" + strtrim("`se3_4'") + ")"
		...
		if pval4_4 < 0.01 local takeup_b4_4 = strtrim("`b4_4'") + "\sym{***}"
		else if pval4_4 < 0.05 local takeup_b4_4 = strtrim("`b4_4'") + "\sym{**}"
		else if pval4_4 < 0.1 local takeup_b4_4 = strtrim("`b4_4'") + "\sym{*}"
		else local takeup_b4_4 = strtrim("`b4_4'")
		local se4_4: display `format' _se[atema_pe_lt]
		local takeup_se4_4 = "(" + strtrim("`se4_4'") + ")"
		
		local takeup_obs_4: display %9.0fc e(N)
		
		test atema_st = atema_pe_st
		local takeup_pval1_4: display `format' r(p)
		
		test atema_st = atema_lt
		local takeup_pval2_4: display `format' r(p)
		
		test atema_pe_st = atema_pe_lt
		local takeup_pval3_4: display `format' r(p)		
		
		
		
	// Model 5
	reghdfe takeup atema_st atema_pe_st atema_lt atema_pe_lt $controls_5, ///
	absorb(grade_21 strata) vce(clustervar school_21)
		...
		if pval3_5 < 0.01 local takeup_b3_5 = strtrim("`b3_5'") + "\sym{***}"
		else if pval3_5 < 0.05 local takeup_b3_5 = strtrim("`b3_5'") + "\sym{**}"
		else if pval3_5 < 0.1 local takeup_b3_5 = strtrim("`b3_5'") + "\sym{*}"
		else local takeup_b3_5 = strtrim("`b3_5'")
		local se3_5: display `format' _se[atema_lt]
		local takeup_se3_5 = "(" + strtrim("`se3_5'") + ")"
		...
		if pval4_5 < 0.01 local takeup_b4_5 = strtrim("`b4_5'") + "\sym{***}"
		else if pval4_5 < 0.05 local takeup_b4_5 = strtrim("`b4_5'") + "\sym{**}"
		else if pval4_5 < 0.1 local takeup_b4_5 = strtrim("`b4_5'") + "\sym{*}"
		else local takeup_b4_5 = strtrim("`b4_5'")
		local se4_5: display `format' _se[atema_pe_lt]
		local takeup_se4_5 = "(" + strtrim("`se4_5'") + ")"
		
		local takeup_obs_5: display %9.0fc e(N)
		
		test atema_st = atema_pe_st
		local takeup_pval1_5: display `format' r(p)
		
		test atema_st = atema_lt
		local takeup_pval2_5: display `format' r(p)
		
		test atema_pe_st = atema_pe_lt
		local takeup_pval3_5: display `format' r(p)	
		
		
		
	// Model 6
	reghdfe takeup atema_st atema_pe_st atema_lt atema_pe_lt $controls_6, ///
	absorb(grade_21 strata) vce(clustervar school_21)
		...
		if pval3_6 < 0.01 local takeup_b3_6 = strtrim("`b3_6'") + "\sym{***}"
		else if pval3_6 < 0.05 local takeup_b3_6 = strtrim("`b3_6'") + "\sym{**}"
		else if pval3_6 < 0.1 local takeup_b3_6 = strtrim("`b3_6'") + "\sym{*}"
		else local takeup_b3_6 = strtrim("`b3_6'")
		local se3_6: display `format' _se[atema_lt]
		local takeup_se3_6 = "(" + strtrim("`se3_6'") + ")"
		...
		if pval4_6 < 0.01 local takeup_b4_6 = strtrim("`b4_6'") + "\sym{***}"
		else if pval4_6 < 0.05 local takeup_b4_6 = strtrim("`b4_6'") + "\sym{**}"
		else if pval4_6 < 0.1 local takeup_b4_6 = strtrim("`b4_6'") + "\sym{*}"
		else local takeup_b4_6 = strtrim("`b4_6'")
		local se4_6: display `format' _se[atema_pe_lt]
		local takeup_se4_6 = "(" + strtrim("`se4_6'") + ")"
		
		local takeup_obs_6: display %9.0fc e(N)
		
		test atema_st = atema_pe_st
		local takeup_pval1_6: display `format' r(p)
		
		test atema_st = atema_lt
		local takeup_pval2_6: display `format' r(p)
		
		test atema_pe_st = atema_pe_lt
		local takeup_pval3_6: display `format' r(p)	
		
		
		
	// Model 7
	reghdfe takeup atema_st atema_pe_st atema_lt atema_pe_lt $controls_7, ///
	absorb(grade_21 strata) vce(clustervar school_21)
		...
		if pval3_7 < 0.01 local takeup_b3_7 = strtrim("`b3_7'") + "\sym{***}"
		else if pval3_7 < 0.05 local takeup_b3_7 = strtrim("`b3_7'") + "\sym{**}"
		else if pval3_7 < 0.1 local takeup_b3_7 = strtrim("`b3_7'") + "\sym{*}"
		else local takeup_b3_7 = strtrim("`b3_7'")
		local se3_7: display `format' _se[atema_lt]
		local takeup_se3_7 = "(" + strtrim("`se3_7'") + ")"
		...
		if pval4_7 < 0.01 local takeup_b4_7 = strtrim("`b4_7'") + "\sym{***}"
		else if pval4_7 < 0.05 local takeup_b4_7 = strtrim("`b4_7'") + "\sym{**}"
		else if pval4_7 < 0.1 local takeup_b4_7 = strtrim("`b4_7'") + "\sym{*}"
		else local takeup_b4_7 = strtrim("`b4_7'")
		local se4_7: display `format' _se[atema_pe_lt]
		local takeup_se4_7 = "(" + strtrim("`se4_7'") + ")"
		
		local takeup_obs_7: display %9.0fc e(N)
		
		test atema_st = atema_pe_st
		local takeup_pval1_7: display `format' r(p)
		
		test atema_st = atema_lt
		local takeup_pval2_7: display `format' r(p)
		
		test atema_pe_st = atema_pe_lt
		local takeup_pval3_7: display `format' r(p)			
...
texdoc init "$output\tables\main\av_table_FS", replace force

	tex \begin{table}[htbp]
	tex \centering
	tex \resizebox{\linewidth}{!}{%
	tex \begin{threeparttable}
	tex \caption{\textbf{First Stage Effects on Take-up}}
	...
	tex \hline \\
	tex $\beta_1$: Treatment (short-term) & `takeup_b1_1' & `takeup_b1_2' & `takeup_b1_3' & `takeup_b1_4' & `takeup_b1_5' & `takeup_b1_6' & `takeup_b1_7' \\
	tex & `takeup_se1_1' & `takeup_se1_2' & `takeup_se1_3' & `takeup_se1_4' & `takeup_se1_5' & `takeup_se1_6' & `takeup_se1_7' \\
	tex [1ex]
	tex $\beta_2$: Parental engagement (short-term) & `takeup_b2_1' & `takeup_b2_2' & `takeup_b2_3' & `takeup_b2_4' & `takeup_b2_5' & `takeup_b2_6' & `takeup_b2_7' \\
	tex & `takeup_se2_1' & `takeup_se2_2' & `takeup_se2_3' & `takeup_se2_4' & `takeup_se2_5' & `takeup_se2_6' & `takeup_se2_7' \\
	tex [1ex]
	tex $\beta_3$: Treatment (long-term) & `takeup_b3_1' & `takeup_b3_2' & `takeup_b3_3' & `takeup_b3_4' & `takeup_b3_5' & `takeup_b3_6' & `takeup_b3_7' \\
	tex & `takeup_se3_1' & `takeup_se3_2' & `takeup_se3_3' & `takeup_se3_4' & `takeup_se3_5' & `takeup_se3_6' & `takeup_se3_7' \\
	tex [1ex]
	tex $\beta_4$: Parental engagement (long-term) & `takeup_b4_1' & `takeup_b4_2' & `takeup_b4_3' & `takeup_b4_4' & `takeup_b4_5' & `takeup_b4_6' & `takeup_b4_7' \\
	tex & `takeup_se4_1' & `takeup_se4_2' & `takeup_se4_3' & `takeup_se4_4' & `takeup_se4_5' & `takeup_se4_6' & `takeup_se4_7' \\
	tex [1ex]
	tex Strata by year fixed effects & \ding{51} & \ding{51} & \ding{51} & \ding{51} & \ding{51} & \ding{51} & \ding{51} \\
	tex \hline \\
	tex [1ex]
	tex $H_0: \beta_1 = \beta_2$ & `takeup_pval1_1' & `takeup_pval1_2' & `takeup_pval1_3' & `takeup_pval1_4' & `takeup_pval1_5' & `takeup_pval1_6' & `takeup_pval1_7' \\
	tex [1ex]
	tex $H_0: \beta_1 = \beta_3$ & `takeup_pval2_1' & `takeup_pval2_2' & `takeup_pval2_3' & `takeup_pval2_4' & `takeup_pval2_5' & `takeup_pval2_6' & `takeup_pval2_7' \\
	tex [1ex] 
	tex $H_0: \beta_2 = \beta_4$ & `takeup_pval3_1' & `takeup_pval3_2' & `takeup_pval3_3' & `takeup_pval3_4' & `takeup_pval3_5' & `takeup_pval3_6' & `takeup_pval3_7' \\
	tex [1ex]
	tex \hline \\ 
	tex [1ex]
	tex Control mean & `takeup_control' & `takeup_control' & `takeup_control' & `takeup_control' & `takeup_control' & `takeup_control' & `takeup_control' \\
	tex N & `takeup_obs_1' & `takeup_obs_2' & `takeup_obs_3' & `takeup_obs_4' & `takeup_obs_5' & `takeup_obs_6' & `takeup_obs_7' \\
	tex [1ex]
	tex \hline \hline \\ 
	tex \end{tabular}
